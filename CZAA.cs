...
namespace HyoutaTools.LastRanker {
	...
	public class CzaaExtract : HyoutaPluginBase.IProgram {
		public int Execute(List<string> args) {
			return CZAA.ExecuteExtract(args);
		}

		public List<string> Identifiers() {
			return new List<string>() { "LastRanker.CZAAextract" };
		}
	}

	public class CzaaPack : HyoutaPluginBase.IProgram {
		public int Execute(List<string> args) {
			return CZAA.ExecutePack(args);
		}

		public List<string> Identifiers() {
			return new List<string>() { "LastRanker.CZAAcompress" };
		}
	}
}
