...
namespace HyoutaTools.LastRanker {
	...
	public class ScmpExtract : HyoutaPluginBase.IProgram {
		public int Execute(List<string> args) {
			return SCMP.ExecuteExtract(args);
		}

		public List<string> Identifiers() {
			return new List<string>() { "LastRanker.SCMPextract" };
		}
	}

	public class ScmpPack : HyoutaPluginBase.IProgram {
		public int Execute(List<string> args) {
			return SCMP.ExecutePack(args);
		}

		public List<string> Identifiers() {
			return new List<string>() { "LastRanker.SCMPpack" };
		}
	}
}
