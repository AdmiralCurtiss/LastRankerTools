...
namespace HyoutaTools.LastRanker {
	...
	public class NpkExtract : HyoutaPluginBase.IProgram {
		public int Execute(List<string> args) {
			return NPK.ExecuteExtract(args);
		}

		public List<string> Identifiers() {
			return new List<string>() { "LastRanker.NPKextract" };
		}
	}

	public class NpkPack : HyoutaPluginBase.IProgram {
		public int Execute(List<string> args) {
			return NPK.ExecutePack(args);
		}

		public List<string> Identifiers() {
			return new List<string>() { "LastRanker.NPKpack" };
		}
	}
}
