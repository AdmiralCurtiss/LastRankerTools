...
namespace HyoutaTools.LastRanker {
	...
	public class RtdpExtract : HyoutaPluginBase.IProgram {
		public int Execute(List<string> args) {
			return RTDP.ExecuteExtract(args);
		}

		public List<string> Identifiers() {
			return new List<string>() { "LastRanker.RTDPextract" };
		}
	}

	public class RtdpPack : HyoutaPluginBase.IProgram {
		public int Execute(List<string> args) {
			return RTDP.ExecutePack(args);
		}

		public List<string> Identifiers() {
			return new List<string>() { "LastRanker.RTDPpack" };
		}
	}
}
